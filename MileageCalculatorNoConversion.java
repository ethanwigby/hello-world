 ...
 * Last Modified: Nov 7/2022 by Ethan Wigby
 * Description: Updated the program to use a combobox instead of Radio Buttons and changed the event handlers 
 * accordingly. 
 */
package ch16;
...
public class MileageCalculatorNoConversion extends Application {
    ...
    private String [] efficiencyType = {defaultResult, altResult};
    private ComboBox<String> cbEfficiencyType = new ComboBox<String>(FXCollections.observableArrayList(efficiencyType));
    ...
    public void start(Stage primaryStage) {   	
        ...
        cbEfficiencyType.setValue(defaultResult);
        ...
        mainPane.add(cbEfficiencyType, 0, 1);
        ...
        cbEfficiencyType.setOnAction(e -> changeLabels());     
    ...
    private void changeLabels() {
    	...
    	if ( (cbEfficiencyType.getValue() == altResult) && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
    		resetForm();
    ...
    private void calcMileage() {       
        ...
        double result = 0.0;
        if (cbEfficiencyType.getValue() == altResult) {
        	// liters / 100KM
